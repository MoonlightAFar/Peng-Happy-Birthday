  ...
  init: function (start) {
    if (start != 0){
      ...
      if (i !== -1) {
        ...
        S.UI.simulate('|#countdown 3||祝|彭森|生日快乐|祝你|抽卡欧气满满|下厨别具一格|拉琴余音绕梁|艺术拿下|祝你|生日快乐！|#icon heart|#icon heart-empty|#icon heart');
      }
...
S.Dot = function (x, y) {
  ...
  this.c = new S.Color(220, 208, 255, this.p.a);
